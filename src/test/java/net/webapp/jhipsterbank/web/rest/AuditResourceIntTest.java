...
import net.webapp.jhipsterbank.config.audit.AuditEventConverter;
import net.webapp.jhipsterbank.domain.PersistentAuditEvent;
import net.webapp.jhipsterbank.repository.PersistenceAuditEventRepository;
import net.webapp.jhipsterbank.service.AuditEventService;
