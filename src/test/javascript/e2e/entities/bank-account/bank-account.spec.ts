...
describe('BankAccount e2e test', () => {
  ...
  it('should load BankAccounts', async () => {
    ...
    expect(await bankAccountComponentsPage.getTitle()).to.eq('jhipsterbankApp.bankAccount.home.title');
    await browser.wait(
  ...
  it('should load create BankAccount page', async () => {
    ...
    expect(await bankAccountUpdatePage.getPageTitle()).to.eq('jhipsterbankApp.bankAccount.home.createOrEditLabel');
  ...
  it('should create and save BankAccounts', async () => {
    ...
    await promise.all([
      ...
      bankAccountUpdatePage.typeSelectLastOption(),
  ...
  it('should delete last BankAccount', async () => {
    ...
    expect(await bankAccountDeleteDialog.getDialogTitle()).to.eq('jhipsterbankApp.bankAccount.delete.question');
