...
describe('Operation e2e test', () => {
  ...
  it('should load Operations', async () => {
    ...
    expect(await operationComponentsPage.getTitle()).to.eq('jhipsterbankApp.operation.home.title');
  ...
  it('should load create Operation page', async () => {
    ...
    expect(await operationUpdatePage.getPageTitle()).to.eq('jhipsterbankApp.operation.home.createOrEditLabel');
  ...
  it('should create and save Operations', async () => {
    ...
    await promise.all([
      ...
      operationUpdatePage.typeSelectLastOption(),
      // operationUpdatePage.labelsSelectLastOption(),
  ...
  it('should delete last Operation', async () => {
    ...
    expect(await operationDeleteDialog.getDialogTitle()).to.eq('jhipsterbankApp.operation.delete.question');
